...
func TestSpec_FromFile(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "NoSpecFile",
			specFiles:    []string{"./fixture/null"},
			spec:         Default(),
			expectedSpec: Default(),
		},
		{
			name:          "EmptySpecFile",
			specFiles:     []string{"./fixture/empty.yaml"},
			spec:          Default(),
			expectedError: "EOF",
		},
		{
			name:          "InvalidSpecFile",
			specFiles:     []string{"./fixture/invalid.yaml"},
			spec:          Default(),
			expectedError: "yaml: unmarshal errors",
		},
		{
			name:      "MinimumSpecFile",
			specFiles: []string{"./fixture/min.yaml"},
			spec:      Default(),
			expectedSpec: Spec{
				Help:    false,
				Version: false,
		...
		},
		{
			...
			specFiles: []string{"./fixture/max.yaml"},
			spec:      Default(),
			expectedSpec: Spec{
				Help:    false,
				Version: false,
