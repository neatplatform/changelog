		...
		},
		{
			...
			g: &Generator{
				...
				repo: &MockRepo{
					...
					FetchParentCommitsMocks: []FetchParentCommitsMock{
						{OutCommits: service.Commits{commit3, commit2, commit1}},
		...
		},
		{
			...
			g: &Generator{
				...
				repo: &MockRepo{
					...
					FetchParentCommitsMocks: []FetchParentCommitsMock{
						{OutCommits: service.Commits{commit3, commit2, commit1}},
						{OutCommits: service.Commits{commit2, commit1}},
					},
		...
		},
		{
			...
			g: &Generator{
				...
				repo: &MockRepo{
					...
					FetchTagsMocks: []FetchTagsMock{
						{OutTags: service.Tags{tag2, tag1}},
					},
					FetchFirstCommitMocks: []FetchFirstCommitMock{},
					FetchParentCommitsMocks: []FetchParentCommitsMock{
						{OutCommits: service.Commits{commit3, commit2, commit1}},
						{OutCommits: service.Commits{commit2, commit1}},
						{OutCommits: service.Commits{commit1}},
					},
					FetchIssuesAndMergesMocks: []FetchIssuesAndMergesMock{
						{
							OutIssues: service.Issues{},
...
func TestGenerator_resolveTags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			sortedTags:    service.Tags{},
			chlog:         &changelog.Changelog{},
			expectedTags:  service.Tags{futureTag1},
			expectedError: nil,
		},
		{
			...
			s:             spec.Tags{},
			sortedTags:    service.Tags{tag1},
			chlog:         &changelog.Changelog{},
			expectedTags:  service.Tags{tag1},
			expectedError: nil,
		},
		{
			...
			sortedTags:    service.Tags{tag1},
			chlog:         &changelog.Changelog{},
			expectedTags:  service.Tags{futureTag2, tag1},
			expectedError: nil,
		},
		{
		...
		},
		{
			...
			expectedTags:  service.Tags{futureTag2},
			expectedError: nil,
		},
		{
			...
			s:          spec.Tags{},
			sortedTags: service.Tags{tag2, tag1},
			chlog: &changelog.Changelog{
				Existing: []changelog.Release{
					{TagName: "v0.1.1"},
				},
			},
			expectedTags:  service.Tags{tag2},
			expectedError: nil,
		},
		{
			...
			expectedTags:  service.Tags{futureTag3, tag2},
			expectedError: nil,
		},
		{
			name: "InvalidFromTag",
		...
		},
		{
			...
			expectedTags:  service.Tags{tag3, tag2},
			expectedError: nil,
		},
		{
		...
		},
		{
			...
			expectedTags:  service.Tags{futureTag4, tag3, tag2},
			expectedError: nil,
		},
	}
...
func TestGenerator_resolveReleases(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			sortedTags: service.Tags{futureTag, tag3},
			baseRev:    "v0.1.2",
			issueMap: issueMap{
