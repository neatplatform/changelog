...
func toUser(u github.User) service.User {
	return service.User{
		Name:     u.Name,
		Email:    u.Email,
		Username: u.Login,
...
func toBranch(b github.Branch) service.Branch {
...
func toTag(t github.Tag, c github.Commit, owner, repo string) service.Tag {
	return service.Tag{
		Name:   t.Name,
...
func toCommit(c github.Commit) service.Commit {
...
func toIssue(i github.Issue, e github.Event, author, closer github.User) service.Issue {
...
func toMerge(i github.Issue, e github.Event, c github.Commit, author, merger github.User) service.Merge {
	labels := make([]string, len(i.Labels))
	for i, l := range i.Labels {
		labels[i] = l.Name
	}
...
func resolveTags(gitHubTags, gitHubCommits *store, owner, repo string) service.Tags {
	tags := service.Tags{}
...
func resolveIssuesAndMerges(gitHubIssues, gitHubEvents, gitHubCommits, gitHubUsers *store) (service.Issues, service.Merges) {
