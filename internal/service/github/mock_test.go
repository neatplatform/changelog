...
func (m *MockGithubService) EnsureScopes(ctx context.Context, scopes ...github.Scope) error {
	if m.EnsureScopesIndex >= len(m.EnsureScopesMocks) {
		panic("EnsureScopes called more times than expected")
	}
...
func (m *MockUsersService) Get(ctx context.Context, username string) (*github.User, *github.Response, error) {
	if m.GetIndex >= len(m.GetMocks) {
		panic("Get called more times than expected")
	}
...
func (m *MockRepoService) Commit(ctx context.Context, ref string) (*github.Commit, *github.Response, error) {
	if m.CommitIndex >= len(m.CommitMocks) {
		panic("Commit called more times than expected")
	}
...
func (m *MockRepoService) Commits(ctx context.Context, pageSize, pageNo int) ([]github.Commit, *github.Response, error) {
	if m.CommitsIndex >= len(m.CommitsMocks) {
		panic("Commits called more times than expected")
	}
...
func (m *MockRepoService) Branch(ctx context.Context, name string) (*github.Branch, *github.Response, error) {
	if m.BranchIndex >= len(m.BranchMocks) {
		panic("Branch called more times than expected")
	}
...
func (m *MockRepoService) Tags(ctx context.Context, pageSize, pageNo int) ([]github.Tag, *github.Response, error) {
	if m.TagsIndex >= len(m.TagsMocks) {
		panic("Tags called more times than expected")
	}
...
func (m *MockIssueService) List(ctx context.Context, pageSize, pageNo int, filter github.IssuesFilter) ([]github.Issue, *github.Response, error) {
	if m.ListIndex >= len(m.ListMocks) {
		panic("List called more times than expected")
	}
...
func (m *MockIssueService) Events(ctx context.Context, number, pageSize, pageNo int) ([]github.Event, *github.Response, error) {
	...
	if m.EventsIndex >= len(m.EventsMocks) {
		panic("Events called more times than expected")
	}
