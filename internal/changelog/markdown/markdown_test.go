...
*This changelog is automatically generated by [changelog](https://github.com/neatplatform/changelog)*
...
func TestProcessor_Parse(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			p: &processor{
				ui:            ui.NewNop(),
				changelogFile: "fixture/CHANGELOG.md",
			},
			opts: changelog.ParseOptions{},
			expectedChangelog: &changelog.Changelog{
				Title: "Changelog",
